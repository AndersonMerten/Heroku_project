...
<html lang="pt">
    <head>
        ...
        <title>VirtualShop SignIn</title>
                ...
                <div id="login" class="animate form">
                    <section class="login_content">
                        ...
                        <form id="frmsignin"  name="frmsignin" method="POST" action="signin">
                            <h1>Autenticação</h1>
                            <div>
                                <input type="email" class="form-control" id="email" name="email" placeholder="Email" value="anderson.merten@gmail.com" required />
                            </div>
                            <div>
                                <input type="password" class="form-control" id="passwd" name="passwd" placeholder="Senha" value="123456" required />
                            </div>
                            <div>
                            <input type="submit" class="btn btn-default submit center-block" value="Autenticar" />${msg}
                            </div>
                            <div class="clearfix"></div>
                            <div class="separator">
                                    <a href="#toregister" class="to_register"> Criar novo usuário </a>
                                <div class="clearfix"></div>
                                <div>
                                    <h2><i class="fa fa-hand-spock-o" style="font-size: 20px;"></i>&nbsp;Anderson Iago Merten</h2>
